...
//newInvCard("NAME", "GROUP", "ERA(EVENT)", "NUMBER", "CODE", "RARITY", TRADERATE, [EVENT]),
  ...
  newInvCard("Yunju", "Mimiirose", "REEBON", 24, "MRU2.f53e", 2, 3),
  newInvCard("Lia", "ITZY", "Halloween", 27, "ILIH.9cda", 2, 1, true),
  ...
  newInvCard("ruka", "BABYMONSTER", "DRIP", 108, "BDRU1.0369", 1, 3),
  ...
  newInvCard("HarCona", "XG", "Ships", 214, "XHCS.d684", 2, 0, true),
  ...
  newInvCard("Dae & Jin", "AB6IX x Cix", "Frosty Friends", 543, "DIF.ec43", 2, 3, true),
  newInvCard("Chuu & Nana", "Solo x WH", "Frosty Friends", 543, "CNF.7418", 2, 2, true),
  newInvCard("Rora", "BABYMONSTER", "DRIP", 574, "BDO1.a53f", 1, 2),
  newInvCard("Yoohyeon", "Dreamcatcher", "VillainS", 588, "DVO2.f585", 2, 2),
  newInvCard("Chaeyeon", "IZ*ONE", "Vampire", 603, "IVCH2.fd98", 2, 2),
  newInvCard("Jurin", "XG", "SOMETHING AIN'T RIGHT", 617, "XSJ1.6899", 1, 0),
  newInvCard("Hinata", "XG", "New DNA", 643, "XNHI2.11f4", 2, 0),
  newInvCard("Chisa", "XG", "WINTER WITHOUT YOU", 656, "XWCH2.571c", 2, 0),
  ...
  newInvCard("Cocona", "XG", "Tippy Toes", 799, "XTO2.bc26", 2, 0),
  ...
  newInvCard("Harvey", "XG", "SHOOTING STAR", 1055, "XHV2.b5ea", 2, 0),
  ...
  newInvCard("Harvey", "XG", "Tippy Toes", 1149, "XTH1.5632", 1, 0),
  newInvCard("Jo Yuri", "Solista", "Glassy", 1181, "SOJY2.d67d", 2, 2),
  newInvCard("Kim Jaehwan", "Solista", "Empty Dream", 1201, "SEN1.424b", 1, 3),
  newInvCard("New", "THE BOYZ", "BE AWAKE", 1216, "TBAN1.7a39", 1, 2),
];
